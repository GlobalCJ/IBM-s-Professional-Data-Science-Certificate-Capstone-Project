...
app.layout = html.Div(children=[html.H1('SpaceX Dashboard - Launch Records',
                                        style={'textAlign': 'center', 'color': '#de184a',
                                               'font-size': 40}),
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                             options=[
                                                {'label': 'Launch Sites - Count of Launch Success', 'value': 'ALL'},
